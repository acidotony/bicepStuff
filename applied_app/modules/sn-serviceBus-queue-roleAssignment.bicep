...
// Metadata
metadata description = 'This template defines role based access control (RBAC) rights for service bus queue resource.'
// Types
type GroupRoleAssignmentType = { group: string, roles: string[], filters: string[]? }
type SiteRoleAssignmentType = { site: string, roles: string[], filters: string[]?, appSettingName: string? }
...
param groupRoleAssignments GroupRoleAssignmentType[] = []
...
param siteRoleAssignments SiteRoleAssignmentType[] = []
