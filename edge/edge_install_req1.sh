...
SA="stsndev2southeastasiaaj1"
KV="kv-sn-dev2-001aj1"
LAW_RG="$RGSHARED"
...
#SQL
SQL_SRV="aj-sn-dev2-sql-001030620251"
SQL_ADMIN="pepito246$"
...
#Relay Name
RELAY_NAME="aj-relay-sn-msdn-030620251"
...
# Relay Name
az relay namespace create --resource-group $RGSHARED --name $RELAY_NAME --location $LOC
